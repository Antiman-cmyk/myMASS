    ...
    if params.encoder_only:
        ...
        if params.reload_model != '':
            ...
            if enc_path != '':
                ...
                # psl
                enc_reload['embeddings.weight'] = enc_reload['embeddings.weight'][:params.n_words, :]
                enc_reload['pred_layer.proj.weight'] = enc_reload['pred_layer.proj.weight'][:params.n_words, :]
                enc_reload['pred_layer.proj.bias'] = enc_reload['pred_layer.proj.bias'][:params.n_words]
            ...
            if dec_path != '':
                ...
                dec_reload['embeddings.weight'] = dec_reload['embeddings.weight'][:params.n_words, :]
                dec_reload['pred_layer.proj.weight'] = dec_reload['pred_layer.proj.weight'][:params.n_words, :]
                dec_reload['pred_layer.proj.bias'] = dec_reload['pred_layer.proj.bias'][:params.n_words]
...
def build_multiLM(params):
    """
    Build model.
    """
    model_pth = params.multiLM
