...
if [ "$SRC" == "ro" -a "$TGT" == "en" ]; then
  PARA_SRC_VALID=$PARA_PATH/dev/newsdev2016-enro-ref.ro
  PARA_TGT_VALID=$PARA_PATH/dev/newsdev2016-roen-ref.en
  PARA_SRC_TEST=$PARA_PATH/dev/newstest2016-enro-ref.ro
  PARA_TGT_TEST=$PARA_PATH/dev/newstest2016-roen-ref.en
fi
if [ "$SRC" == "zh" -a "$TGT" == "zh" ]; then
  PARA_SRC_VALID=$PARA_PATH/dev/newsdev2017-enzh-ref.zh
  PARA_TGT_VALID=$PARA_PATH/dev/newsdev2017-zhen-ref.en
  PARA_SRC_TEST=$PARA_PATH/dev/newstest2017-enzh-ref.zh
  PARA_TGT_TEST=$PARA_PATH/dev/newstest2017-zhen-ref.en
fi
...
#  cd $MONO_PATH/de
#  wget --no-check-certificate -c http://www.statmt.org/wmt14/training-monolingual-news-crawl/news.2007.de.shuffled.gz
#  wget --no-check-certificate -c http://www.statmt.org/wmt14/training-monolingual-news-crawl/news.2008.de.shuffled.gz
...
if [ "$SRC" == "en" -o "$TGT" == "en" ]; then
  ...
  cd $MONO_PATH/en
#  wget --no-check-certificate -c http://www.statmt.org/wmt14/training-monolingual-news-crawl/news.2007.en.shuffled.gz
#  wget --no-check-certificate -c http://www.statmt.org/wmt14/training-monolingual-news-crawl/news.2008.en.shuffled.gz
  wget --no-check-certificate -c http://data.statmt.org/wmt18/translation-task/news-commentary-v13.en.gz
...
#  cd $MONO_PATH/fr
#  wget --no-check-certificate -c http://www.statmt.org/wmt14/training-monolingual-news-crawl/news.2007.fr.shuffled.gz
#  wget --no-check-certificate -c http://www.statmt.org/wmt14/training-monolingual-news-crawl/news.2008.fr.shuffled.gz
#  wget --no-check-certificate -c http://www.statmt.org/wmt14/training-monolingual-news-crawl/news.2009.fr.shuffled.gz
...
#  cd $MONO_PATH/ro
#  wget --no-check-certificate -c http://data.statmt.org/wmt16/translation-task/news.2015.ro.shuffled.gz
#fi
#
if [ "$SRC" == "zh" -o "$TGT" == "zh" ]; then
  ...
  cd $MONO_PATH/zh
  wget --no-check-certificate -c https://data.statmt.org/wmt18/translation-task/news-commentary-v13.zh.gz
fi
...
wget --no-check-certificate -c http://data.statmt.org/wmt18/translation-task/dev.tgz
