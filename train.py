...
from src.model import check_model_params, build_model, build_multiLM
...
def get_parser():
    ...
    parser.add_argument("--multi_gpus", type=bool_flag, default=False)
    parser.add_argument("--prefix", type=bool_flag, default=False)
    parser.add_argument("--temperature", type=float, default=None)
    parser.add_argument("--topk", type=int, default=1)
    parser.add_argument("--multiLM", type=str, default="",
                        help="Reload the second pretrained model")
...
def main(params):
    ...
    if params.multi_gpus:
        ...
        params.local_rank = 0
        params.multi_gpu = True if params.n_gpu_per_node > 1 else False
